...
import com.danrley.barbershop.databinding.ActivityAgendamentoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        datePicker.init(year, monthOfYear, dayOfMonth) { _, year, monthOfYear, dayOfMonth ->
            ...
            if (monthOfYear < 10) {
             ...
             data = "$dia / $mes / $year"
            // Restante do código para manipular a data selecionada
        }
        ...
        binding.btAgendar.setOnClickListener {
            ...
            when {
                ...
                hora < "8:00" && hora > "19:00" -> {
                    mensagem(it, "Estabelecimento fechado. Atendimento: 08:00 as 19:00", "#FF0000")
                }
                data.isEmpty() -> {
                    mensagem(it, "Insira a data!", "#FF0000")
                }
    ...
    private fun salvarAgendamento(view: View, cliente: String, barbeiro: String, data: String, hora: String){
       val db = FirebaseFirestore.getInstance()
        ...
        db.collection("agendamento").document(cliente).set(dadosUsuario).addOnCompleteListener{
            mensagem(view, "Agendamento realizado com sucesso", "#DD83DAC5")
